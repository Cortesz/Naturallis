...
public class MultipleChoiceLunch extends DialogFragment {

    public interface onMultipleChoiceLunch {
        void onPositiveButtonClicked(String[] list, ArrayList<String> selectedItemlist);
        void onNegativeButtonClicked();
    }

    onMultipleChoiceLunch mListener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        try {
            mListener= (onMultipleChoiceLunch) context;
        } catch (Exception e) {
