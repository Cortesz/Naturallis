...
public class MultipleChoiceBreakfast extends DialogFragment {

    public interface onMultipleChoiceBreakfast{
        void onPositiveButtonClicked(String[] list, ArrayList<String> selectedItemlist);
        void onNegativeButtonClicked();
    }

    onMultipleChoiceBreakfast mListener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        try {
            mListener= (onMultipleChoiceBreakfast) context;
        } catch (Exception e) {
